...
print(multiplexer.dmux_8_way(1, [0, 1, 1]))
print(multiplexer.dmux_8_way(1, [1, 0, 0]))
print(multiplexer.dmux_8_way(1, [1, 0, 1]))
print(multiplexer.dmux_8_way(1, [1, 1, 0]))
print(multiplexer.dmux_8_way(1, [1, 1, 1]))
print()
